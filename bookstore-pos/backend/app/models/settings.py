...
Contiene ajustes globales de la tienda.
"""
...
class SystemSettings(Base):
    ...
    payment_methods: Mapped[str] = mapped_column(
        String(255), default="CASH,CARD,TRANSFER"
    )
    ...
    receipt_footer: Mapped[str] = mapped_column(
        String(500), default="Gracias por su compra"
    )
