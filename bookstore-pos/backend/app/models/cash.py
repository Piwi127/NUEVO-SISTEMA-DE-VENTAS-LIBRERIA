"""
Modelos de gestión de caja y sesiones de efectivo.
Contiene clases para sesiones, movimientos y arqueos de caja.
"""
...
class CashMovement(Base):
    """Movimiento de efectivo (entrada/salida) en una sesión."""
