"""
Router de órdenes de compra y pagos a proveedores.
Endpoints: POST/GET /purchasing/orders, POST /purchasing/orders/{id}/receive, POST /purchasing/payments
"""
...
from app.services.inventory.purchasing_service import PurchasingService
...
@router.get(
    ...
    response_model=list[PurchaseOrderItemOut],
    dependencies=[Depends(require_permission("purchases.read"))],
)
...
@router.post(
    "/payments", dependencies=[Depends(require_permission("purchases.create"))]
)
