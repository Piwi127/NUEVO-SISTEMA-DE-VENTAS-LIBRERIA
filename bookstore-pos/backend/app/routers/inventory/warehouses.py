"""
Router de almacenes.
Endpoints: GET/POST /warehouses, PUT /warehouses/{id}, POST /warehouses/transfer, /batch, /count
"""
...
from app.services.inventory.warehouses_service import WarehousesService
...
async def create_transfer(
    ...
    """Crea una transferencia de stock entre almacenes."""
    service = WarehousesService(db, current_user)
...
async def create_count(
    ...
    """Registra un conteo de inventario físico."""
    service = WarehousesService(db, current_user)
