...
import { Box, IconButton, Table, TableBody, TableCell, TableHead, TableRow, TextField, useMediaQuery, Paper, Typography, Stack } from "@mui/material";
            ...
            <Paper key={item.product_id} sx={{ p: 1.5, display: "grid", gap: 1 }}>
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Stack direction="row" spacing={0.5} alignItems="center">
                  <IconButton size="small" onClick={() => cart.setQty(item.product_id, normalizeQty(item.qty - 1))}>
                  ...
                  />
                  <IconButton size="small" onClick={() => cart.setQty(item.product_id, item.qty + 1)}>
